## verylu
[![](https://www.herokucdn.com/deploy/button.png)](https://heroku.com/deploy?template=https://github.com/hdbheuj/verylu.git)
...
![image](https://cdn.jsdelivr.net/gh/hdbheuj/verylu/doc/1.png)

请求`/speedtest/`，html5-speedtest测速页面

![image](https://cdn.jsdelivr.net/gh/hdbheuj/verylu/doc/2.png)

请求`/test/`，文件下载速度测试

![image](https://cdn.jsdelivr.net/gh/hdbheuj/verylu/doc/3.png)
